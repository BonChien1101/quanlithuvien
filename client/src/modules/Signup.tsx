...
export default function Signup(){  
    const [username, setUsername] = useState(''); // State cho tendn
    const [password, setPassword] = useState(''); // State cho mk
    const [passwordConfirm, setPasswordConfirm] = useState(''); // state xnhan mk
